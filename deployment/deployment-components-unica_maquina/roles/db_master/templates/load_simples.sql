...
################
# Criar Gamers
insert into gamer (id, classificacao, data_nascimento, estado, nome, numero_classificacoes, avatar_id, grupo_id) values (1, 5, '1997-06-14 04:45:03', 'Male', 'GameHub', 1, 1, NULL);
